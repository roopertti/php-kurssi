    ...
    <div class="container">
    	<div class="row">
    		...
    		<div class="col-md-6">
				...
				if($result !== null) {
					echo "<div class='well'>";
					echo "<table class='table'><thead><th>Avain</th><th>Nimi</th><th>Osoite</th><th>PostNro</th><th>AsTy</th><th>Edit</th><th>Delete</th>";
					echo "<tbody>";
					while($row = mysqli_fetch_assoc($result)) {
						...
						echo "<td><a class='btn btn-warning' href='./update.php?id=" . $row['avain'] . "'>Edit</a></td>";
						echo "<td><a class='btn btn-danger' href='./delete.php?id=" . $row['avain'] . "'>Poista</a></td>";
						echo "<tr>";
					}
					echo "</tbody>";
					echo "</table>";
